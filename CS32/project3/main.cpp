...
int main()
    ...
    // the get function enables a client to iterate over all elements of a List
           ...
           // Hawkeye
            ...
            // test get method
            string x;
            cout << x << endl;                  // print empty string
            assert( l1.get(6,x) == false);
            cout << x << endl;                  // x remains unchanged
            assert( l1.get(-1,x) == false);
            cout << x << endl;                  // x remains unchanged
            assert( l1.get(5,x) == true);
            cout << x << endl;                  // x has a value
           ...
           assert( l1.before( "Not there", "Not there" ) == false );
           ...
           assert( l1.before( "Hulk", "Hulk" ) == false );
        ...
        // should remove nothing, size stays the same
        l1.removeAllBiggerThan("zzz");
        assert( l1.size() == 2 );
        assert( l1.position( "Hawkeye" ) == -1 );
        assert( l1.position( "Thor" ) == -1 );
        assert( l1.position( "Hulk" ) == -1 );
        ...
        // should remove all elements, size = 0
        ...
        assert( l1.position( "Black Widow" ) == -1 );
        assert( l1.position( "Iron Man" ) == -1 );
        assert( l1.position( "Captain America" ) == -1 );
        assert( l1.position( "Not there" ) == -1 );
